...
По идее, самым общим процессом работы с выделениями был бы процесс типа copy/cut и past. Действительно,
...
гуруппу выделенных объектов, надо сменить контекст, т.е. найти подходящую запись. Здесь мы и можем 
