...
namespace Factograph.Data
{
    public class FDataService : IFDataService
    {
        ...
        private CassInfo[] cassettes = new CassInfo[0];
        private FogInfo[] fogs = new FogInfo[0];
        ...
        public void Init()
        {
            ...
            if (connectionstring != null)
            {
                ...
                if (XConfig != null) PrepareFogs(XConfig);
            ...
            //var look = adapter.GetRecord("famwf1233_1021", true);
        }
        ...
        public int gibibCount = 0;
        public int gibibCommon = 0;
        public string GetLook() { return gibibCount.ToString() + " " + gibibCommon; }

        public XElement GetItemByIdBasic(string id, bool addinverse)
        {
            var val = adapter.GetItemByIdBasic(id, addinverse);
            gibibCount++;
            if (val != null) gibibCommon += val.Elements().Count();
            return val;
        }
