...
{
    public class RMemAdapter : DAdapter
    {
        ...
        public RMemAdapter(Func<string, string>? normalize)
        {
        ...
        {
            if (connectionstring != null && connectionstring.StartsWith("rmem:"))
            {
                dbfolder = connectionstring.Substring("rmem:".Length);
            }
            ...
            records = new USequence(tp_rec, null, GenStream3,
            ...
            var names_ind = new SVectorIndex(GenStream3, records, skey);
            names_ind.Refresh();
            ...
            svwords = new UVecIndex(GenStream3, records, toWords,
            ...
            inverse_index = new UVecIndex(GenStream3, records, ext_keys, v => Hashfunctions.HashRot13((string)v));
