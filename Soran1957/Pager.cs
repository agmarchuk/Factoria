...
namespace Soran1957
{
    public class Pager
    {
        ...
        static string style_logo = "";//"position:fixed; left:150px; top:0px; width:auto; height:61px;";
        static string style_logi = "";//"position:fixed; right:0px; top:0px; width:380px; height:61px;";
        static string style_menu = "";//"position:fixed; left:0px; top:100px; width:150px; height:auto;";
        static string style_sear = "";//"position:fixed; left:150px; top:100px; right:380px; width:auto; height:80px;";

        public XElement ConstructPage(HttpRequest request)
        {
            
            string? sdirection = request.Query["sdirection"];
            ...
            string? searchstring = (string?)(request?.Query["searchstring"]);
            if (searchstring != null) BuildSearchResults(centralPanel, rightPanel, searchstring, sdirection);
            else BuildItem(centralPanel, rightPanel, string.IsNullOrWhiteSpace(request?.Query["id"]) ? home_id : request?.Query["id"]);
            ...
            XElement logo =
                new XElement("div", new XAttribute("id", "logo"), new XAttribute("style", style_logo),
                    ...
                    new XElement("a", new XAttribute("href", ""),
                        new XElement("img", new XAttribute("src", "PublicuemCommon/soran1957styles/img/logo2.gif"),
                ...
                new XElement("div", new XAttribute("id", "login"), new XAttribute("style", style_logi),
                    new XElement("table", new XAttribute("cellpadding", "0"), new XAttribute("cellspacing", "0"),
                        ...
                        new XElement("tr",
                            ...
                            new XElement("td",
                                new XElement("input", new XAttribute("type", "image"), new XAttribute("width", "19"), new XAttribute("height", "19"), new XAttribute("src", "PublicuemCommon/soran1957styles/img/btn_login.gif")))),
            ...
            XElement menu =
                new XElement("div", new XAttribute("id", "menu"), new XAttribute("style", style_menu),
                    new XElement("a", new XAttribute("href", "?id=" + home_id),
                        new XElement("img",
                            new XAttribute("src", "PublicuemCommon/soran1957styles/img/i_home.gif"),
                    ...
                    new XElement("a", new XAttribute("href", "mailto:pavl@iis.nsk.su?subject=soran1957.ru%20 " + (string.IsNullOrWhiteSpace(request.Query["id"]) ? home_id : request.Query["id"])),
                        new XElement("img", new XAttribute("src", "PublicuemCommon/soran1957styles/img/i_mail.gif"), new XAttribute("width", "10"),
                    ...
                    new XElement("div", new XAttribute("class", "text_menu"),
                        new XElement("div", new XAttribute("class", "p_menu"),
                            new XElement("a", new XElement("b", "Начало"), request.Query["id"] == home_id ? null : new XAttribute("href", "?id=" + home_id)),
                            new XElement("hr", new XAttribute("noshade", "1"), new XAttribute("size", "3"), new XAttribute("color", "#cccccc")),
                            new XElement("a", new XElement("b", "СО РАН"), request.Query["id"] == soran_id ? null : new XAttribute("href", "?id=" + soran_id)),
                            new XElement("hr", new XAttribute("noshade", "1"), new XAttribute("size", "3"), new XAttribute("color", "#cccccc")),
                            new XElement("a", new XElement("b", "Первичные фотоматериалы"), request.Query["p"] == database_id ? null : new XAttribute("href", "?id=" + database_id)),
                            new XElement("hr", new XAttribute("noshade", "1"), new XAttribute("size", "3"), new XAttribute("color", "#cccccc")),
                            ...
                            new XElement("hr", new XAttribute("noshade", "1"), new XAttribute("size", "3"), new XAttribute("color", "#cccccc")),
                            new XElement("a", new XElement("b", "О проекте"), request.Query["p"] == about_id ? null : new XAttribute("href", "?id=" + about_id)),
                            new XElement("hr", new XAttribute("noshade", "1"), new XAttribute("size", "3"), new XAttribute("color", "#cccccc")),
                            new XElement("a", new XElement("b", "Полезные ссылки"), request.Query["id"] == soran_id ? null : new XAttribute("href", "?id=" + usefullLinks_id)),
                            null),
                        null),
                    new XElement("hr", new XAttribute("noshade", "1"), new XAttribute("size", "3"), new XAttribute("color", "#cccccc")),
                    null);
                            ...
                            new XElement("tr",
                                ...
                                new XElement("td", new XAttribute("class", "search_form"),
                                    new XElement("input",
                                        ...
                                        new XAttribute("src", "PublicuemCommon/soran1957styles/img/btn_search.gif"),
            ...
            XElement html = new XElement("html",
                new XElement("head",
                    new XElement("link", new XAttribute("rel", "stylesheet"), new XAttribute("href", "PublicuemCommon/soran1957styles/zh.css"), new XAttribute("type", "text/css")),
                    new XElement("link", new XAttribute("rel", "stylesheet"),
                      new XAttribute("type", "text/css"), new XAttribute("href", "PublicuemCommon/Styles.css")),
                    new XElement("script",
        ...
        {
            centralPanel.Add(new XText("centralPanel context"));
            rightPanel.Add(new XText("rightPanel context"));
            /*
            ...
            if (description != null)
            {
                centralPanel.Add(description,
                                    new XElement("a", new XAttribute("href", "mailto:pavl@iis.nsk.su?subject=soran1957.ru" + (string.IsNullOrWhiteSpace(request.Query["id"]) ? home_id : request.Query["id"])),
                        new XElement("img", new XAttribute("src", "PublicuemCommon/soran1957styles/img/i_mail.gif"), new XAttribute("width", "10"),
        ...
        */
        ...
        {
            centralPanel.Add(new XText("BuildSearchResults for centralPanel"));
            rightPanel.Add(new XText("BuildSearchResults for rightPanel"));
            /*
